  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="mobilejhipsterApp.preferences.home.createOrEditLabel">
            <Translate contentKey="mobilejhipsterApp.preferences.home.createOrEditLabel">Create or edit a Preferences</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : preferencesEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="KG">{translate('mobilejhipsterApp.Units.KG')}</option>
                  <option value="LB">{translate('mobilejhipsterApp.Units.LB')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
