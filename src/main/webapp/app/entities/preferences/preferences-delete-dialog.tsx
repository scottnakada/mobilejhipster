...
export const PreferencesDeleteDialog = (props: IPreferencesDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mobilejhipsterApp.preferences.delete.question">
        <Translate contentKey="mobilejhipsterApp.preferences.delete.question" interpolate={{ id: preferencesEntity.id }}>
