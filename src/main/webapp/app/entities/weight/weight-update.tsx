  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="mobilejhipsterApp.weight.home.createOrEditLabel">
            <Translate contentKey="mobilejhipsterApp.weight.home.createOrEditLabel">Create or edit a Weight</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : weightEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="timestampLabel" for="weight-timestamp">
                  <Translate contentKey="mobilejhipsterApp.weight.timestamp">Timestamp</Translate>
                </Label>
                <AvInput
                  id="weight-timestamp"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label id="weightLabel" for="weight-weight">
                  <Translate contentKey="mobilejhipsterApp.weight.weight">Weight</Translate>
                </Label>
                <AvField
                  id="weight-weight"
                  type="string"
              ...
              <AvGroup>
                <Label for="weight-user">
                  <Translate contentKey="mobilejhipsterApp.weight.user">User</Translate>
                </Label>
