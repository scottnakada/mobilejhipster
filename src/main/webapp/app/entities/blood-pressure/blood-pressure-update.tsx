  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="mobilejhipsterApp.bloodPressure.home.createOrEditLabel">
            <Translate contentKey="mobilejhipsterApp.bloodPressure.home.createOrEditLabel">Create or edit a BloodPressure</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : bloodPressureEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="timestampLabel" for="blood-pressure-timestamp">
                  <Translate contentKey="mobilejhipsterApp.bloodPressure.timestamp">Timestamp</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="systolicLabel" for="blood-pressure-systolic">
                  <Translate contentKey="mobilejhipsterApp.bloodPressure.systolic">Systolic</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="diastolicLabel" for="blood-pressure-diastolic">
                  <Translate contentKey="mobilejhipsterApp.bloodPressure.diastolic">Diastolic</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label for="blood-pressure-user">
                  <Translate contentKey="mobilejhipsterApp.bloodPressure.user">User</Translate>
                </Label>
