  ...
  return (
    <div>
      <h2 id="points-heading">
        <Translate contentKey="mobilejhipsterApp.points.home.title">Points</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="mobilejhipsterApp.points.home.createLabel">Create new Points</Translate>
        </Link>
      </h2>
        ...
        {pointsList && pointsList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="mobilejhipsterApp.points.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('exercise')}>
                  <Translate contentKey="mobilejhipsterApp.points.exercise">Exercise</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('meals')}>
                  <Translate contentKey="mobilejhipsterApp.points.meals">Meals</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('alcohol')}>
                  <Translate contentKey="mobilejhipsterApp.points.alcohol">Alcohol</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('notes')}>
                  <Translate contentKey="mobilejhipsterApp.points.notes">Notes</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="mobilejhipsterApp.points.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="mobilejhipsterApp.points.home.notFound">No Points found</Translate>
            </div>
          )
        )}
      </div>
