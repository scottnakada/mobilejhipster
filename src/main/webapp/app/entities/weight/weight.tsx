  ...
  return (
    <div>
      <h2 id="weight-heading">
        <Translate contentKey="mobilejhipsterApp.weight.home.title">Weights</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="mobilejhipsterApp.weight.home.createLabel">Create new Weight</Translate>
        </Link>
      </h2>
          ...
          {weightList && weightList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('timestamp')}>
                    <Translate contentKey="mobilejhipsterApp.weight.timestamp">Timestamp</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('weight')}>
                    <Translate contentKey="mobilejhipsterApp.weight.weight">Weight</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="mobilejhipsterApp.weight.user">User</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="mobilejhipsterApp.weight.home.notFound">No Weights found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
