...
export const BloodPressureDeleteDialog = (props: IBloodPressureDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mobilejhipsterApp.bloodPressure.delete.question">
        <Translate contentKey="mobilejhipsterApp.bloodPressure.delete.question" interpolate={{ id: bloodPressureEntity.id }}>
