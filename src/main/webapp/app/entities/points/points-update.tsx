  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="mobilejhipsterApp.points.home.createOrEditLabel">
            <Translate contentKey="mobilejhipsterApp.points.home.createOrEditLabel">Create or edit a Points</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : pointsEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="dateLabel" for="points-date">
                  <Translate contentKey="mobilejhipsterApp.points.date">Date</Translate>
                </Label>
                <AvField
                  id="points-date"
                  type="date"
              ...
              <AvGroup>
                <Label for="points-user">
                  <Translate contentKey="mobilejhipsterApp.points.user">User</Translate>
                </Label>
