  ...
  return (
    <div>
      <h2 id="blood-pressure-heading">
        <Translate contentKey="mobilejhipsterApp.bloodPressure.home.title">Blood Pressures</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="mobilejhipsterApp.bloodPressure.home.createLabel">Create new Blood Pressure</Translate>
        </Link>
      </h2>
          ...
          {bloodPressureList && bloodPressureList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('timestamp')}>
                    <Translate contentKey="mobilejhipsterApp.bloodPressure.timestamp">Timestamp</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('systolic')}>
                    <Translate contentKey="mobilejhipsterApp.bloodPressure.systolic">Systolic</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('diastolic')}>
                    <Translate contentKey="mobilejhipsterApp.bloodPressure.diastolic">Diastolic</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="mobilejhipsterApp.bloodPressure.user">User</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="mobilejhipsterApp.bloodPressure.home.notFound">No Blood Pressures found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
